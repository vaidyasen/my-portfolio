...
const AdminSkills = () => {
 ...
 const getLevelColor = (level) => {
  switch (level) {
   case "Expert":
    return "bg-red-100 text-red-800/20";
   case "Advanced":
    return "bg-orange-100 text-orange-800/20";
   case "Intermediate":
    return "bg-yellow-100 text-yellow-800/20";
   default:
    return "bg-green-100 text-green-800/20";
  }
 };
 ...
 const getCategoryColor = (category) => {
  const colors = {
   Frontend:
    "bg-blue-100 text-blue-800/20",
   Backend:
    "bg-purple-100 text-purple-800/20",
   Database:
    "bg-indigo-100 text-indigo-800/20",
   DevOps: "bg-gray-100 text-gray-800",
   Mobile:
    "bg-pink-100 text-pink-800/20",
   Design:
    "bg-cyan-100 text-cyan-800/20",
   Tools:
